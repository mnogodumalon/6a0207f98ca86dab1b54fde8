...
const PROXY_BASE = '';
const APP_ID = '6a0207f001dba46714f8636c';
...
export default function PublicFormAbcEingabe() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">ABC Eingabe — Formular</h1>
        </div>
